...
<body>
    ...
    <div class="main">
        <div class="left-container">
            <div class="img_container" style="display: flex; gap: 50px;">
                <ul>
                    <li><img src="../Res/product-page1-product1.webp" alt="image-product-1-thumbnail" class="smallImg">
                    </li>
                    <li><img src="../Res/product-page1-product2.webp" alt="image-product-2-thumbnail" class="smallImg">
                    </li>
                ...
                <div class="img_holder"><img src="../Res/product-page1-product1.webp" alt="image-product"
                        id="mainImage"></div>
            </div>
            <div id="bottom_button" class="bottom_button" style="display: flex; gap: 10px;margin-left: 100px;">
        ...
        <div class="right-container">
            <div class="right_list hidden p_id" style="display: none; position: absolute;">1</div>
            <div class="right_list hidden p_url" style="display: none; position: absolute;">toy.php</div>
            <div class="right_list hidden p_img_url" style="display: none; position: absolute;">
                ../Res/product-page1-product1.webp</div>
            <div class="right_list pro_name">
                <h2 class="p_name">Pet Dog Ball Teeth Silicon Toy Sound Silicone Squeaky Toy For Dog & Cat Squeak Toys
                    for Pets</h2>
            </div>
            ...
            <div class="right_list pro_price">
                <h2><span class="rupee_symbol"></span><span class="p_price">129</span></h2>
                <div class="pro_lprice" style="display: flex;">
                    ...
                    <h4>
                        <span class="d_space"
                            style="color: hsl(26, 100%, 55%); font-size: 16px; text-align: center;border-radius: 5px;">35%
                            off</span>
                    </h4>
                </div>
            </div>
            ...
            <div class="right_list pro_desc_long" style="color:hsl(219, 9%, 45%)">
                Squeeze to relax and release stress. Non-toxic material, safe for your pet to play. Perfect for
                controlling pet behavioral problems. Amuse yourself and friends when playing fetch with your dog. A
                fantastic and very funny toy ball, your dog will go crazy and keep playing it without tiredness.
            </div>
        </div>
    ...
    <script>
        ...
        SmallImg[0].onclick = function () {
            MainImg.src = "../Res/product-page1-product1.webp";
        }
        SmallImg[1].onclick = function () {
            MainImg.src = "../Res/product-page1-product2.webp";
        }
