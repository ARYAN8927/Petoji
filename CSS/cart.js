...
function addToCart() {
  ...
  var product_id = document.querySelector('.p_id').innerText;
  // var product_id = document.getElementsByClassName('.p_id').innerText;

  var product_name = document.querySelector('.right_list h2.p_name').innerText;
  var product_price = document.querySelector('.right_list span.p_price').innerText;
  var product_l_price = document.querySelector('.right_list span.p_l_price').innerText;
  var product_quantity = document.querySelector('.right_list span.p_qty').innerText;
  var product_url = document.querySelector('.p_url').innerText;
  // var product_url = document.getElementsByClassName('.p_url').innerText;

  var product_img_url = document.querySelector('.p_img_url').innerText;
  // var product_img_url = document.getElementsByClassName('.p_img_url').innerText;

  var product_xptd_delivery = document.querySelector('.right_list span.p_xptd_delivery').innerText;


  // Create a new object with product information
  var product = {id: product_id, name: product_name, price: product_price, l_price: product_l_price, quantity: product_quantity, p_url: product_url, p_img_url: product_img_url, p_xptd_delivery: product_xptd_delivery};
  ...
  if (cartItems) {
    ...
    cartItems.forEach(function (item) {
      ...
      <div class="prod_cart_info prod_title">
        ...
        <span class="xptd_delivery">Delivery Expected in ${item.p_xptd_delivery} Day(s)</span>
      </div>
